...
from region.p_regions.azp import AZPReactiveTabu
...
def test_scipy_sparse_matrix():
    cluster_object = AZPReactiveTabu(
        max_iterations=max_it, k1=k1, k2=k2, random_state=0
    )
    cluster_object.fit_from_scipy_sparse_matrix(adj, attr, n_regions=n_reg)
...
def test_graph_dict_basic():
    ...
    cluster_object.fit_from_networkx(graph, attr_dict, n_regions=n_reg)
    result = region_list_from_array(cluster_object.labels_)
    compare_region_lists(result, optimal_clustering)
...
def test_scipy_sparse_matrix_multi_attr():
    ...
    cluster_object.fit_from_scipy_sparse_matrix(adj, double_attr, n_regions=n_reg)
    obtained = region_list_from_array(cluster_object.labels_)
    compare_region_lists(obtained, optimal_clustering)
...
def test_geodataframe_multi_attr():
    ...
    cluster_object.fit_from_geodataframe(gdf, double_attr_str, n_regions=n_reg)
    obtained = region_list_from_array(cluster_object.labels_)
    compare_region_lists(obtained, optimal_clustering)
...
def test_dict_multi_attr():
    ...
    cluster_object.fit_from_dict(neighbors_dict, double_attr_dict, n_regions=n_reg)
    obtained = region_list_from_array(cluster_object.labels_)
    compare_region_lists(obtained, optimal_clustering)
...
def test_graph_str_multi_attr():
    ...
    cluster_object.fit_from_networkx(graph, double_attr_str, n_regions=n_reg)
    result = region_list_from_array(cluster_object.labels_)
    compare_region_lists(result, optimal_clustering)
...
def test_w_multi_attr():
    ...
    cluster_object.fit_from_w(w, double_attr, n_regions=n_reg)
    result = region_list_from_array(cluster_object.labels_)
    compare_region_lists(result, optimal_clustering)
